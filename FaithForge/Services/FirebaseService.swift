...
// Uncomment these imports once firebase-ios-sdk is added via SPM:
// import FirebaseCore
// import FirebaseAuth
...
final class FirebaseService {
    ...
    func handleAppleSignIn(result: Result<ASAuthorization, Error>) async {
        ...
        case .success(let auth):
            ...
            // Stub behavior (remove when Firebase SDK is added):
            await MainActor.run {
                self.isSignedIn = true
                self.userID = appleCredential.user
    ...
    func createOrUpdateUserDocument(profile: UserProfileData? = nil) async throws {
        ...
        _ = userID // Suppress unused warning in stub
    ...
    func fetchLeaderboard(period: String, limit: Int = 50) async throws -> [LeaderboardData] {
        ...
        return [] // Stub: returns empty until Firebase SDK is added
    }
    ...
    func sendFriendRequest(toUserID: String) async throws {
        guard let userID else { return }
        _ = (userID, toUserID) // Suppress unused warning
